...
ENV_TO_IMPORT: dict[Environment, str] = {
    ...
    'client': 'game:GetService("Players").LocalPlayer:FindFirstChildOfClass("PlayerScripts") :: PlayerScripts',
...
class LuaPath:
    ...
    def to_lua_relative(self):
        ...
        expr = expr = self._append_parts('script.Parent', parts)
    ...
    def to_lua(self, resolver: LuaPathResolver, inline_require: bool = False):
        ...
        expr = expr = self._append_parts(expr_root, parts)
        return self._post_process(expr)
